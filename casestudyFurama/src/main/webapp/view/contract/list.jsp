...
<html>
<head>
    <title>Contract Manager Application</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-5 header text-center fs-1">Constract</div>
...
<%--    </h2>--%>
<%--    <h2>--%>
<%--        <a href="/furama?action=create"> Add New Contract</a>--%>
<%--    </h2>--%>
<%--    <form action="/furama">--%>
